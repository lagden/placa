 ...
 * @param {string} [proxyOpts.host='201.92.20.5']   - Proxy host
 * @param {number} [proxyOpts.port=53281]           - Proxy port
 * @return {Object} Os dados do veículo.
 */
async function service(placa, proxyOpts = {host: '201.92.20.5', port: 53281}) {
	let codigo
