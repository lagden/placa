 ...
 * @param {string} [proxyOpts.host='177.5.98.58']   - Proxy host
 * @param {number} [proxyOpts.port=20183]           - Proxy port
 * @return {Object} Os dados do veículo.
 */
async function service(placa, proxyOpts = {host: '177.5.98.58', port: 20183}) {
	let codigo
